...
export default function IdentifyRole() {
 ...
 const router = useRouter(); 
  ...
  }, [registerStep, selectedRole, username, firstName, lastName,isCompleteOtp,instituteType,instituteName]);
...
const handleEmailVerification = async () => {
  ...
  try {
    ...
    console.log(instituteName,instituteType,email,password,username,'helo my peop');
        ...
        return (
          <div className="flexcenter flex-col h-[90vh] w-screen">
            ...
            <div className="flex flex-col max-w-[330px] w-full sm:max-w-[561px] gap-5">
              ...
              <button disabled={isValidEmail} onClick={handleEmailVerification} className={` text-white font-bold py-2 px-4 rounded w-full h-[57px] rounded-[8px] sm:rounded-[10px] text-[18px] leading-[57px] ${isValidEmail ? 'bg-[#404040] cursor-not-allowed' : 'btn2'}`}>
                {buttonDisabledtext}
              </button>
              {errormessage && (
          ...
          <div className="flexcenter flex-col h-screen w-screen">
            ...
            <div className="flex flex-col gap-10 max-w-[330px] w-full sm:max-w-[561px]">
                ...
                <div className="flex flex-col gap-1 max-w-[330px] w-full sm:max-w-[561px]">
                    ...
                    <button onClick={verifyOtpWithBackend} className={`h-[60px] w-full rounded-[15px]  ${otpCode.length === 6 ? 'btn2' :'bg-[#404040] cursor-not-allowed disabled ' }`}>Verify</button>
