...
export const AcademyGloblaxcontex = createContext()
export const AcademyGloblaxcontexProvider = ({ children }) => {
...
const [instituteType, setSelectedinstituteType] = useState('');
const [instituteName, setSelectedinstituteName] = useState('');
...
console.log(selectedRole, "selectedRole");
  ...
  const handleContinue = () => {
    if (registerStep === 1 && !instituteType && !instituteName ) {
  ...
  return (
    <AcademyGloblaxcontex.Provider value={{Successmessage, setSuccessmessage,registerStep, setRegisterStep,handleContinue,selectedRole, setSelectedRole,setCodeName,username,firstName, setFirstName,lastName, setLastName,email, setEmail,password, setPassword,handlesubmitform,disablebtn,setdisablebtn,confirmpassword, 
    setconfirmpassword,isCompleteOtp, setIsCompleteOtp,successValue,setsuccessvalue,stack,setStack,errormessage,setErrormessage,password, setPassword,confirmpassword, setconfirmpassword,otpCode, setOtpCode,verifyOtpWithBackend,instituteType, setSelectedinstituteType,instituteName, setSelectedinstituteName}}>
      {children}
    </AcademyGloblaxcontex.Provider>
  );
};