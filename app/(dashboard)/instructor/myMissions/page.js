    ...
    <div className="flex flex-col h-full gap-10 w-full">
      <div className="  h-fit w-full flex flex-col gap-10    ">
        <div className="hidden sm:flex h-fit justify-between  w-full">
          <div>
            <p className="text-[var(--sidebar-hovercolor)] font-[600] leading-[40px] text-[42px] ">
              My Missions
            </p>
            <p className="text-[var(--text)] text-[13px] xl:text-[15px] leading-[40px] ">
              Here you see all your uploaded courses
            </p>
          </div>
          <div>
        ...
        <div className="sm:hidden ">
          <div
            style={{ padding: "10px" }}
            className="sm:hidden bg-[#0F0F0F] rounded-[10px]  flex items-center justify-between w-full gap-3 sm:hidden "
          >
            <div className="flexcenter w-full h-full flex-col gap-2 text-[#7343B3] font-[600] text-[31px] leading-[11px] ">
              1
              <p className="text-[var(--background)] text-[8px] leading-[11px] ">
                Total Missions
              </p>
            </div>
        ...
        <div className="grid gap-5 sm:grid-cols-2  w-full xl:grid-cols-3">
          {studetcourse.slice(0, 9).map((el) => (
            <Link href={`/instructor/myMissions/${el.id}`} key={el.id}>
              <div className="  w-full flex flex-col xl:max-w-[410.14px] h-[447.91px] bg-[#0F0F0F] rounded-[20px] p-4 shrink-0">
                <div
