                    ...
                    <div style={{ padding: '15px' }} className="flex bg-[var(--black-background)] flex-col gap-5 sm:col-span-3 h-fit w-full">
                            ...
                            <div className="flex flex-col xl:flex-row xl:items-center gap-3">
                                ...
                                <div>
                                    <p className="font-[600] text-[26px] sm:text-[35px] leading-[150%]">
                                        {userUpdatedValue?.firstName || "First"} <span>{userUpdatedValue?.lastName || "Last"}</span>
                                    </p>
                        ...
                        <div className="w-full">
                            ...
                            <div className="grid grid-cols-2 w-full items-center">
                                ...
                                <div className="text-[#818181] xl:text-[18px] leading-[20px] text-[8px]">{userUpdatedValue?.email || "N/A"}</div>
                                <div className="text-[#ADA5A5] font-[700] text-[13px] xl:text-[19px] leading-[40px]">Phone Number</div>
                                <div className="text-[#818181] xl:text-[18px] leading-[20px] text-[8px]">{userUpdatedValue?.Phone || "N/A"}</div>
                                <div className="text-[#ADA5A5] font-[700] text-[13px] xl:text-[19px] leading-[40px]">Gender</div>
                                <div className="text-[#818181] xl:text-[18px] leading-[20px] text-[8px]">{userUpdatedValue?.gender || "N/A"}</div>
                                <div className="text-[#ADA5A5] font-[700] text-[13px] xl:text-[19px] leading-[40px]">Nationality</div>
                                <div className="text-[#818181] xl:text-[18px] leading-[20px] text-[8px]">{userUpdatedValue?.nationality || "N/A"}</div>
                                <div className="text-[#ADA5A5] font-[700] text-[13px] xl:text-[19px] leading-[40px]">Date Of Birth</div>
                                <div className="text-[#818181] xl:text-[18px] leading-[20px] text-[8px]">{userUpdatedValue?.dateOfBirth || "N/A"}</div>
                                <div className="text-[#ADA5A5] font-[700] text-[13px] xl:text-[19px] leading-[40px]">Preferred Language</div>
                                <div className="text-[#818181] xl:text-[18px] leading-[20px] text-[8px]">{userProfile?.preferredLanguage || "N/A"}</div>
                            </div>
                        </div>
                        ...
                        <div className="w-full">
                            ...
                            <div className="grid grid-cols-2 w-full">
                                ...
                                <div className="text-[#818181] xl:text-[18px] leading-[20px] text-[12px]">{userUpdatedValue?.website || "N/A"}</div>
                                <div className="text-[#ADA5A5] font-[700] text-[13px] xl:text-[19px] leading-[40px]">LinkedIn</div>
                                <div className="text-[#818181] xl:text-[18px] leading-[20px] text-[12px]">{userUpdatedValue?.linkedin || "N/A"}</div>
                                <div className="text-[#ADA5A5] font-[700] text-[13px] xl:text-[19px] leading-[40px] text-[12px]">Instagram</div>
                                <div className="text-[#818181] xl:text-[18px] leading-[20px] text-[12px]">{userUpdatedValue?.instagram || "N/A"}</div>
                                <div className="text-[#ADA5A5] font-[700] text-[13px] xl:text-[19px] leading-[40px]">X</div>
                                <div className="text-[#818181] xl:text-[18px] leading-[20px] text-[12px]">{userUpdatedValue?.Twitter || "N/A"}</div>
                                <div className="text-[#ADA5A5] font-[700] text-[13px] xl:text-[19px] leading-[40px]">Facebook</div>
                                <div className="text-[#818181] xl:text-[18px] leading-[20px] text-[12px]">{userUpdatedValue?.facebook || "N/A"}</div>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="w-full grid sm:grid-cols-2 gap-5">
                                    <div>
                                        <Editprofilebtn 
                                            ...
                                            onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, firstName: e.target.value })} 
                                            label="First Name" 
                                        />
                                        
                                        <Editprofilebtn 
                                            value={userUpdatedValue?.username || ""} 
                                            onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, username: e.target.value })} 
                                            label='Username' 
                                        />
                                       
                                        <Editprofilebtn 
                                            value={userUpdatedValue?.Phone || ""} 
                                            onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, Phone: e.target.value })} 
                                            placeholder={'12345'} 
                                            label='Phone Number' 
                                            type="tel"
                                        />
                                        <Editprofilebtn 
                                            ...
                                            onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, nationality: e.target.value })} 
                                            label='Nationality' 
                                        />
                                    </div>
                                    <div className="flex flex-col gap-0">
                                        <Editprofilebtn 
                                            ...
                                            onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, email: e.target.value })} 
                                            label='Email Address' 
                                            type="email"
                                        />
                                        <Editprofilebtn 
                                            value={userUpdatedValue?.lastName || ""} 
                                            onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, lastName: e.target.value })} 
                                            label='Last Name' 
                                        />
                                        <div className="grid grid-cols-2 gap-5 w-full">
                                            <div className="flex flex-col gap-3">
                                                ...
                                                <EditprofileRadiobtn 
                                                    ...
                                                    onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, gender: e.target.value })} 
                                                    label='Male' 
                                                />
                                            </div>
                                        ...
                                        <Editprofilebtn 
                                            ...
                                            onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, dateOfBirth: e.target.value })} 
                                            label='Date Of Birth' 
                                            type="date"
                                        />
                                    </div>
                            ...
                            <>
                                <div>
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <textarea
                                            style={{ padding: '10px' }}
                                            name='bio'
                                            onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, bio: e.target.value })}
                                ...
                                <div>
                                    <Editprofilebtn 
                                        ...
                                        onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, Headline: e.target.value })} 
                                        label="Headline" 
                                        placeholder="Product Designer || Tutor" 
                                    />
                                    <Editprofilebtn 
                                        value={userUpdatedValue?.ExpertiseTags || ""} 
                                        onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, ExpertiseTags: e.target.value })} 
                            ...
                            <div className='h-fit'>
                                <div className="mb-5">
                                    <Editprofilebtn 
                                        ...
                                        onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, youtube: e.target.value })} 
                                ...
                                <div className="w-full grid sm:grid-cols-2 gap-5">
                                    <div>
                                        <Editprofilebtn 
                                            ...
                                            onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, facebook: e.target.value })} 
                                            placeholder="e.g facebook.com/etienoekanem" 
                                        />
                                        <Editprofilebtn 
                                            label="Linkedin" 
                                            value={userUpdatedValue?.linkedin || ""} 
                                            onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, linkedin: e.target.value })} 
                                            placeholder="e.g linkedin.com/in/etienoekanem" 
                                        />
                                        <Editprofilebtn 
                                            label="Instagram" 
                                            value={userUpdatedValue?.instagram || ""} 
                                            onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, instagram: e.target.value })} 
                                    ...
                                    <div className="flex flex-col gap-0 sm:block">
                                        <Editprofilebtn 
                                            ...
                                            onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, Twitter: e.target.value })} 
                                        ...
                                        <div className="grid grid-cols-2 sm:grid-cols-1 gap-0">
                                            ...
                                            <Editprofilebtn 
                                                ...
                                                onChange={(e) => setUserUpdatedValue({ ...userUpdatedValue, website: e.target.value })} 
